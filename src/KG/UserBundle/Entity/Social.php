 ...
 * @ORM\Entity(repositoryClass="KG\UserBundle\Repository\SocialRepository")
 */
class Social
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="KG\UserBundle\Entity\User", inversedBy="socials", cascade={"remove"})
     */
    private $user;
